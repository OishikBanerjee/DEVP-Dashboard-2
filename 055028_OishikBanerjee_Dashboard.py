...
data_path = r"C:\Users\OISHIK BANERJEE\Downloads\archive (5)\Imports_Exports_Dataset.csv"  # Modify the path as needed
dataset = pd.read_csv(data_path)

# Sample dataset
sdset = dataset.sample(n=min(3001, len(dataset)), random_state=55028)  # Adjust to actual length
